...
from diff import diff, get_diff, build_region_specs, dict_to_tuple, is_feasible_next_placement
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dest_dir', default='', help='where to write samples')
